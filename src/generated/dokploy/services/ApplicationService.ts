...
export class ApplicationService {
     ...
     * @throws ApiError
     */
    public static applicationCreate(
        requestBody: {
            name: string;
            appName?: string;
     ...
     * @throws ApiError
     */
    public static applicationReload(
        requestBody: {
            appName: string;
            applicationId: string;
        },
     ...
     * @throws ApiError
     */
    public static applicationDelete(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationStart(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationRedeploy(
        requestBody: {
            applicationId: string;
            title?: string;
            description?: string;
     ...
     * @throws ApiError
     */
    public static applicationSaveEnvironment(
        requestBody: {
            applicationId: string;
            env?: string | null;
     ...
     * @throws ApiError
     */
    public static applicationSaveBuildType(
        requestBody: {
            applicationId: string;
     ...
     * @throws ApiError
     */
    public static applicationSaveGithubProvider(
        requestBody: {
            applicationId: string;
     ...
     * @throws ApiError
     */
    public static applicationSaveGitlabProvider(
        requestBody: {
            applicationId: string;
     ...
     * @throws ApiError
     */
    public static applicationSaveBitbucketProvider(
        requestBody: {
     ...
     * @throws ApiError
     */
    public static applicationSaveGiteaProvider(
        requestBody: {
            applicationId: string;
     ...
     * @throws ApiError
     */
    public static applicationSaveDockerProvider(
        requestBody: {
     ...
     * @throws ApiError
     */
    public static applicationSaveGitProdiver(
        requestBody: {
     ...
     * @throws ApiError
     */
    public static applicationDisconnectGitProvider(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationMarkRunning(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationUpdate(
        requestBody: {
            applicationId: string;
            name?: string;
            appName?: string;
     ...
     * @throws ApiError
     */
    public static applicationRefreshToken(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationDeploy(
        requestBody: {
            applicationId: string;
            title?: string;
            description?: string;
     ...
     * @throws ApiError
     */
    public static applicationCleanQueues(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static applicationReadTraefikConfig(
        applicationId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static applicationUpdateTraefikConfig(
        requestBody: {
            applicationId: string;
     ...
     * @throws ApiError
     */
    public static applicationReadAppMonitoring(
        appName: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static applicationCancelDeployment(
        requestBody: {
            applicationId: string;
        },
    ): CancelablePromise<any> {
