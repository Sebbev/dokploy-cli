...
export class BitbucketService {
     ...
     * @throws ApiError
     */
    public static bitbucketGetBitbucketRepositories(
        bitbucketId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static bitbucketTestConnection(
        requestBody: {
            bitbucketId: string;
            bitbucketUsername?: string;
            bitbucketEmail?: string;
