...
export class VolumeBackupsService {
     ...
     * @throws ApiError
     */
    public static volumeBackupsCreate(
        requestBody: {
            name: string;
            volumeName: string;
            prefix: string;
     ...
     * @throws ApiError
     */
    public static volumeBackupsOne(
     ...
     * @throws ApiError
     */
    public static volumeBackupsDelete(
        requestBody: {
            volumeBackupId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static volumeBackupsUpdate(
        requestBody: {
            name: string;
            volumeName: string;
            prefix: string;
     ...
     * @throws ApiError
     */
    public static volumeBackupsRunManually(
        requestBody: {
            volumeBackupId: string;
        },
    ): CancelablePromise<any> {
