...
export class UserService {
     ...
     * @throws ApiError
     */
    public static userGetUserByToken(
        token: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static userAssignPermissions(
        requestBody: {
            id: string;
     ...
     * @throws ApiError
     */
    public static userDeleteApiKey(
        requestBody: {
            apiKeyId: string;
        },
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public static userCreateApiKey(
        requestBody: {
            name: string;
            prefix?: string;
            expiresIn?: number;
     ...
     * @throws ApiError
     */
    public static userCheckUserOrganizations(
        userId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static userSendInvitation(
        requestBody: {
            invitationId: string;
