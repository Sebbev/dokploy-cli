...
export class DockerService {
	 ...
	 * @throws ApiError
	 */
	public static dockerGetContainers(serverId?: string): CancelablePromise<any> {
	 ...
	 * @throws ApiError
	 */
	public static dockerRestartContainer(requestBody: {
		containerId: string;
	 ...
	 * @throws ApiError
	 */
	public static dockerGetConfig(containerId: string, serverId?: string): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: "GET",
